...
export default function Projects() {
    ...
    return (
        <section id='projects' className='relative bg-gradient-to-r from-slate-500 to-slate-800 py-10 px-4'>
            <div className='mb-16 max-w-7xl mx-auto'>
                <h2 className='text-3xl font-bold mb-8 text-white border-b border-red-500 w-max pb-4'>Projetos e participações</h2>
